<template>
    <div class="flex mt-10 w-full">
        <div class="w-28 my-auto text-gray-700">Follow me on</div>
        <a href="https://github.com/yogesh7401" target="_blank"> 
            <svg version="1.1" class="w-8"  id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                <g>
                    ...
                    <path 
                        d="M256,0C114.6,0,0,114.6,0,256s114.6,256,256,256s256-114.6,256-256S397.4,0,256,0z M477.9,256L477.9,256
        ...
        <a href="https://www.facebook.com/people/Yogeshwaran/100051837720812/" target="_blank">
            <svg version="1.1" fill="#34D399" class="w-8 ml-3" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <g>
                    <path fill="#000" d="M256,0c71.1,0,131.6,24.9,181.3,74.7S512,184.9,512,256c0,70.4-24.9,130.7-74.7,180.8S327.1,512,256,512
        ...
        <a href="mailto:yogeshwaran7401@gmail.com" target="_blank">
            <svg version="1.1" class="w-8 ml-3" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                <g>
                    <path d="M256,0C114.6,0,0,114.6,0,256c0,141.4,114.6,256,256,256c141.4,0,256-114.6,256-256C512,114.6,397.4,0,256,0z M276.9,319.3
        ...
        <a href="https://www.instagram.com/yogesh7401_/" target="_blank">
            <svg version="1.1" class="w-8 ml-3" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                <g id="XMLID_1_">
                    ...
                    <path id="XMLID_7_" class="st0" d="M310.9,146.2H196.4c-16.8,0-31.7,5.6-41,14.9c-9.3,9.3-14.9,24.2-14.9,41v114.5
                    ...
                    <path id="XMLID_10_" class="st0" d="M256,0C114.5,0,0,114.5,0,256s114.5,256,256,256s256-114.5,256-256C512.9,114.5,397.5,0,256,0z
        ...
        <a href="https://www.linkedin.com/in/yogesh-waran-ab08ab195/" target="_blank">
            ...
            <g id="XMLID_1_">
                ...
                <path fill="skyblue" id="XMLID_7_" class="st1" d="M187.1,374.2V217.8h-48.4v156.4H187.1z M187.1,162.9c0-14-9.3-24.2-25.1-24.2
