<template>
    <div class="pt-28 pb-10 min-h-screen container w-full mx-auto">
        <div class="sm:mx-8 mx-5 mb-5 flex justify-end ">
            <select :onchange="e => filterRepo(e.target.value)" class="p-1 px-3 ml-auto border-green-600 w-36 bg-green-200 text-green-800 dark:bg-card dark:text-white rounded-md outline-none select">
