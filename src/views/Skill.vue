...
import LuffyRun from "../assets/luffy run.gif"
export default {
    components: { StarProgress },
    name : 'Skill',
    data() {
        return {
            StartProgress : StarProgress,
            LuffyRun: LuffyRun,
            Skills : [
                {
                    name : "HTML/CSS",
